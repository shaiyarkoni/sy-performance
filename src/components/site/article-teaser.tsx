        ...
        <Reveal className="mt-12">
          <article className="group grid overflow-hidden rounded-2xl border border-line bg-surface transition-colors duration-300 hover:border-volt/50 lg:grid-cols-2">
            ...
            <div className="flex flex-col justify-center p-7 lg:p-10">
              ...
              <h3 className="mt-4 text-2xl font-black text-balance transition-colors group-hover:text-volt sm:text-3xl">
                {featured.title}
              </h3>
              ...
              <Reveal key={article.id} delay={index * 0.07}>
                ...
                >
                  ...
                  <div className="flex flex-1 flex-col p-5">
                    ...
                    <h3 className="mt-2 text-lg leading-snug font-black transition-colors group-hover:text-volt">
                      {article.title}
                    </h3>
